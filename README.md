...
Have been only tested in [LÖVE 11.3]. 
No guarantee it will work on other versions.
...
Mode | Mode of love.graphics.circle. Default to "fill".
...
![Demo of Colors](docs/Colors.png)

## Installation
First Copy the "monkey love" lua file and the folder with the same name into the directory of your project. 
...
At last, in love's callbacks add:
